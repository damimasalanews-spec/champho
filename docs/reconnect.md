...
solveWindowEndsAt is absolute server time. Reconnect does not restart the three-second window. If expired, the room is round_end and THROW remains disabled.
